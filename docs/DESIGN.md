...
- **Primary & Secondary:** A range of Indigo shades provides visual hierarchy. Primary Indigo (#4F46E5) is the core brand touchpoint, optimized for a light-mode first experience.
- **Neutrals:** A sophisticated Slate/Zinc scale handles text and UI scaffolding. 
- **Theming:** 
    - **Light Mode (Default):** High-contrast text on white and off-white surfaces with 1px soft borders. Surfaces use subtle shifts from pure white to soft slate-tints.
...
This design system utilizes **Inter** across all levels to maintain a cohesive, utilitarian feel. 
